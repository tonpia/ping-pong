# ============================================================
# Basys 3 constraints  -  baseline OV7670 + VGA pipeline
# ============================================================
...
# ---- Pushbutton (resend SCCB config) -----------------------
set_property PACKAGE_PIN U18 [get_ports btn]
set_property IOSTANDARD LVCMOS33 [get_ports btn]

# ---- Slide switches : filter selection ---------------------
...
# PCLK is sourced on a non-clock-capable pin -- allow it
