...
// Start-up delay: the OV7670 needs ~10 ms after XCLK / power
// becomes stable before it will ACK SCCB writes.  At 25 MHz
// 1_000_000 cycles is 40 ms which is comfortably above the
// datasheet minimum.  Without this gate the first few register
// writes can be silently dropped, leaving the camera in a
// half-configured state.
reg  [19:0] start_delay = 20'd0;
