...
REM
REM Generated by Vivado on Sun May 10 12:31:54 +0700 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_vga_sync_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_vga_sync_vlog.prj -log xvlog.log
