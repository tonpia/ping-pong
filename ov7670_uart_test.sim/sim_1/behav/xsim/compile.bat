...
REM
REM Generated by Vivado on Sun May 10 11:35:09 +0700 2026
...
echo "xvlog --incr --relax -prj tb_frame_buffer_vlog.prj"
call xvlog  --incr --relax -prj tb_frame_buffer_vlog.prj -log xvlog.log
